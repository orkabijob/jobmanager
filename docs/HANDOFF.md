...
**Tests: 342/342 green** (`dotnet test`). Work is on feature branches; **nothing merged to `master`** (production deploy gate — requires explicit sign-off). **One pending migration awaits that deploy: `AddIncidentReportStatus`.**
