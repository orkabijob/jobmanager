...
_Companion: `docs/personas-and-gaps.md` (persona detail). Tests are at **414/414**. Post-deploy persona-review findings: see docs/review-findings.md as of this writing._
